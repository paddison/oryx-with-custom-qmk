...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LEFT_ALT,    KC_LEFT_CTRL,   KC_TRANSPARENT,                                 KC_LEFT,        MT(MOD_RCTL, KC_DOWN),MT(MOD_RALT, KC_UP),KC_RIGHT,       KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [4] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_LCBR,        MT(MOD_RALT, KC_LBRC),TD(DANCE_1),    KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_RIGHT_CTRL,  MT(MOD_RALT, KC_EQUAL),KC_COLN,        KC_SCLN,        KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_RCBR,        KC_RBRC,        TD(DANCE_2),    KC_TRANSPARENT,                                 KC_BSLS,        KC_RIGHT_GUI,   KC_PLUS,        KC_PIPE,        KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [5] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    KC_TRANSPARENT, KC_F5,          KC_F6,          KC_F7,          KC_F8,          TO(6),                                          KC_TRANSPARENT, KC_RIGHT_CTRL,  KC_RIGHT_ALT,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [6] = LAYOUT_voyager(
    KC_TRANSPARENT, TO(7),          KC_TRANSPARENT, TO(0),          KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [7] = LAYOUT_voyager(
    KC_TRANSPARENT, TO(6),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [3] = { {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {0,0,255}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {0,0,255}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {0,0,255}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {0,0,255}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {0,0,255}, {188,106,248}, {188,106,248} },

    [4] = { {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {0,0,255}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {0,0,255}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {0,0,255}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {0,0,255}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {0,0,255}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {0,0,255}, {188,106,248}, {188,106,248} },

    [6] = { {0,0,255}, {145,57,250}, {145,57,250}, {145,57,250}, {145,57,250}, {145,57,250}, {145,57,250}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {145,57,250}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {145,57,250}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {145,57,250}, {145,57,250}, {145,57,250}, {145,57,250}, {145,57,250}, {145,57,250}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {145,57,250}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {145,57,250}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {188,106,248}, {145,57,250}, {188,106,248}, {188,106,248} },
